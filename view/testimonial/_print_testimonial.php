...
<body>
	<div class="container">
		...
		<div class="text">
			...
			<div class="text-body">
				This is to certify Mr./Miss'.(trim(get_floating_text($student_name, 25, -6, 250))).' ................................... Son/Daughter of Mr'.(trim(get_floating_text($father_name, 25, -6, 266))).'................................................Mrs '.(trim(get_floating_text($mother_name, 25, -6, 150))).'.................................... <br>Date of Birth  '.(trim(get_floating_text($date_of_birth, 7, -6, 210))).'....................................... Reg. No'.(trim(get_floating_text($bnc_roll, 15, -5))).'...............  Session'.(trim(get_floating_text($session, 20, -6))).'  ...................... Examination Roll No'.(trim(get_floating_text($roll, 20, -6, 100))).'................. Permanent <br> Address'.(trim(get_floating_text(substr($permanent_address,0,50), 20, -6, 200))).'.......................................................................................... P.O'.(trim(get_floating_text($po, 30, -6, 200))).'........................................ 
				PS'.(trim(get_floating_text($ps, 30, -6, 200))).'................................................. <br> District'.(trim(get_floating_text($district, 40, -6, 200))).'........................................,Bangladesh was a student of the
				'.(trim(get_floating_text($institute, 10, -6, 200))).'................................................................................................. <br> From '.(trim(get_floating_text($start_date, 20, -6, 200))).'.......................................   to'.(trim(get_floating_text($end_date, 20, -6))).' ...............................................
				He/ She passed the Diploma in Nursing Science & Midwifery <br> held in '.(trim(get_floating_text($final_exam_date, 30, -6, 200))).'............................................ obtaining CGPA '.(trim(get_floating_text($cgpa, 20, -6, 50))).'.............Scale of 4.To the best  of my knowledge, during the period of his/her study at this institution, he/she bear a good moral character and did not take part in any subversive activity of the state. I wish <br> his/ her every success in life.  
			</div>
		</div>
