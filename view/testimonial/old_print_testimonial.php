...
<body>
	<div class="container">
		...
		<div class="text">
			...
			<div class="text-body">
				This is to certify Mr. /Miss'.(trim(get_floating_text($student_name, 25, -2, 250))).'....................................................................................................................................................................... <br>
				Son/Daughter of Mr'.(trim(get_floating_text($father_name, 25, -2, 266))).'................................................................................. Mrs'.(trim(get_floating_text($mother_name, 25, -2, 150))).'...................................................................................... <br>
				Date of Birth'.(trim(get_floating_text($date_of_birth, 20, -2, 210))).'..................................... Reg. No'.(trim(get_floating_text($bnc_roll, 30, -2))).'............................  Session'.(trim(get_floating_text($session, 40, -2))).'.................................. Examination Roll No'.(trim(get_floating_text($roll, 40, -2, 100))).'.................... <br>
				Permanent Address'.(trim(get_floating_text(substr($permanent_address,0,32), 20, -2, 200))).'.......................................................................................... P.O'.(trim(get_floating_text($po, 30, -2, 200))).'................................................................................ <br>
				PS'.(trim(get_floating_text($ps, 30, -2, 200))).'...................................................................................  District'.(trim(get_floating_text($district, 40, -2, 200))).'.........................................................., Bangladesh was a student of <br>
				the'.(trim(get_floating_text($institute, 10, -2, 200))).'..........................................................................................................................  From '.(trim(get_floating_text($start_date, 20, -2, 200))).'.................................   to'.(trim(get_floating_text($end_date, 20, -2))).'.............................. <br>
				He/She passed the Diploma in Nursing Science & Midwifery held in '.(trim(get_floating_text($final_exam_date, 30, -2, 200))).'.................................... obtaining CGPA '.(trim(get_floating_text($cgpa, 32, -2, 100))).'................. Scale of 4. <br>
