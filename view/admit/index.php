      ...
      <div class="col-md-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <?php 
                if (!empty($_POST['session']) && !empty($_POST['semester']) && !empty($_POST['term']) && !empty($_POST['date']) ) {
              ...
              ?>
                ...
                <form class="form-horizontal" action="index.php" method="post">
                  ...
                  <button class="btn btn-success" type="submit"> <span class="fa fa-print"></span> Print Admit</button>
                </form>
