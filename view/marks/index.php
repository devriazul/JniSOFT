<?php 
  ...
  <div class="right_col" role="main">
      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form id="myform" action="index.php" method="GET" class="form-horizontal">
              <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-md-5 col-md-offset-3">
                    <input name="search_roll" required type="text" class="form-control" placeholder="Student Roll">
                  </div>
                </div>
                <div class="form-group">
    ...
    <?php 
      if (!empty($_GET['search_roll']) && !empty($_GET['session'])) {
          $db_student = new App\student\Student();
          $student = $db_student->assign(array('roll' => $_GET['search_roll'], 'session' => $_GET['session']))->single_by_roll();
