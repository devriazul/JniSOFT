<?php
	...
	if (!empty($_POST['student_id'])) {
		if ($db_student->assign(array('student_id' => $_POST['student_id']))->check() ) {
			...
			$dompdf = new Dompdf();
			$dompdf->loadHtml(get_html($student, $profile));
	...
	<div class="container">
		...
		<div class="header">
			...
			<div class="box-middle">
				<br>
				<span>'.(is_array($institute)?$institute['_value']:'NURSING INSTITUTE ..............................').'</span>
				<br><span>College Code: '.(is_array($code)?$code['_value']:'...........').'</span><br><br>
		...
		<div class="info">
			<div class="info-left">
				...
				'.(is_array($clg_subject)?$clg_subject['_value']:'<Add subject from settings>').'<br>
			</div>
...
//die();
    ...
    $html .= '<tr>
    		'.($flag==0?"<td rowspan=\"$rowspan\">
					Year $year <br>
					Semester 1 <br>
					<p style=\"text-align: left;\">Month: January<br> 
					Year: 2017</p>
				</td>":"").'
