...
if (session_status() == PHP_SESSION_NONE) {
	...
	if ($db_student->assign(array('student_id' => $_POST['student_id']))->check() ) {
		...
		$dompdf = new Dompdf();
		$dompdf->loadHtml(print_testimonial($cgpa, $student, $profile ));
	...
	<div class="container">
		<div class="head">
			...
			<div class="head-title">
				<div class="name">
					'.(is_array($institute)?$institute['_value']:'SAIC NURSING COLLEGE').'
				</div>
				<div class="address">
					Mirpur, Dhaka
				</div>
		...
		<div class="text">
			...
			<div class="text-body">
				This is to certify Mr. /Miss '.(trim(get_floating_text($student_name, 10, -15, 250))).'......................................................................................................................................................................... <br>
				Son/Daughter of Mr '.(trim(get_floating_text($father_name, 10, -15, 266))).'................................................................................. Mrs '.(trim(get_floating_text($mother_name, 10, -15, 250))).'......................................................................................... <br>
				Date of Birth '.(trim(get_floating_text($date_of_birth, 10, -15, 210))).'..................................Reg. No'.(trim(get_floating_text($bnc_roll, 10, -13))).'.............................Session'.(trim(get_floating_text($session, 10, -13))).'...................................Examination Roll No '.(trim(get_floating_text($roll, 10, -15, 100))).'................................ <br>
				Permanent Address '.(trim(get_floating_text($student_name, 10, -15, 200))).'..................................................................................... P.O'.(trim(get_floating_text($student_name, 10, -13, 200))).'......................................................................................... <br>
				PS'.(trim(get_floating_text($student_name, 10, -13))).'......................................................................................District'.(trim(get_floating_text($student_name, 10, -13))).'.............................................................., Bangladesh was a student of <br>
				the '.(trim(get_floating_text($student_name, 10, -15, 200))).'..................................................................................................................................From '.(trim(get_floating_text($student_name, 10, -15, 200))).'...................................to'.(trim(get_floating_text($student_name, 10, -13))).'.............................. <br>
				He/She passed the Diploma in Nursing Science & Midwifery held in '.(trim(get_floating_text($student_name, 10, -15, 200))).'................................ obtaining CGPA '.(trim(get_floating_text($cgpa, 10, -15, 100))).'.............................. Scale 4. <br>
		...
		<div class="footer">
			<div class="date">
				Date:'.(trim(get_floating_text(date('d F Y', time()), 5, -7))).'................................	
			</div>
			<div class="sign">
				Principal <br>
...
function get_floating_text($text, $left = 100, $top = -25, $min_width = 500) {
	...
	return '<i style="position: relative; width: 0; height: 0;">
			    <i style="position: absolute; min-width: '.$min_width.'px; left: '.$left.'px; top: '.$top.'px;">
			        '.$text.'
			    </i>
			</i>';
